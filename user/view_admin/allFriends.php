                    ...
                    <tbody class="list">
                        ...
                        if (count($allFriends) > 0) {
                            ...
                            <td class="budget" id="alignRight">
                                <a href="user_confirm?id='.$userReq['ID_User'].'" class="btn btn-sm btn-info">Удалить</a>
                                <a href="user_noconfirm?id='.$userReq['ID_User'].'" class="btn btn-sm btn-default">Написать</a>
                            </td>
                            ...
                            echo '<tr>
                                ...
                                <div class="media align-items-center">
                                <div class="media-body">
                                    <span class="mb-0 text-sm">У Вас нет друзей (</span>
                                </div>
                                </div>
                                </tr>
                                ';
