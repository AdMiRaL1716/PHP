                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label class="form-control-label" for="input-username">Пользователь</label>
                                            <input type="text" id="input-username" class="form-control form-control-alternative" name="Login" placeholder="Логин" value="<?php echo $faqOne->Login; ?>" required="">
                                        </div>
                                    </div>
                                </div>
                            </div>
